...
const AddCoffee = () => {
    const handleCoffee = event => {
        ...
        fetch('https://online-assignment-server-psi.vercel.app/coffee', {
    ...
    return (
        ...
        <div className=''>
            ...
            <div className="border w-full lg:w-1/2 flex justify-center mx-auto  ">

                <form onSubmit={handleCoffee}>
                    {/* form row */}
                    <div className="md:flex mb-3 md:mb-7 ">
                    ...
                    <input type="submit" value="Add Assignment" className="btn btn-block btn-error text-white mb-3" />
