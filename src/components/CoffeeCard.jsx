        ...
        <div className="card border card-side bg-base-100 shadow-xl mb-5 flex flex-col lg:flex-row ">
            ...
            <div className="w-full lg:w-1/2 pr-4  my-auto">
                <div className="text-start space-y-1 p-3">
                    ...
                    <p><span className="font-bold"> Marks:</span> {quantity}</p>
                    <p><span className="font-bold"> Email:</span> {supplier}</p>
                    <p><span className="font-bold"> Level:</span> {taste}</p>
                    <p><span className="font-bold"> Due Date:</span> {date}</p>
                    <p><span className="font-bold"> Details:</span> {details}</p>
                    {/* <p>Photo URL: {photo}</p> */}
                </div>
                <div className="card-actions mt-4">
                    <div className="btn-group lg:btn-group-horizontal space-x-2 lg:space-x-3 mb-5">
